					...
					for(i in owner.breakdowns) {
						...
						console.log(paids);
							...
							$('<td/>', { html: '<div class="payment-method">'+
												'<a href="#" class=" method cash btn btn-info btn-xs method-cash" data-paidall="0" data-surcharge = "'+surcharges+'" data-interest = "'+interests+'" data-tfo_amount = "'+amountt+'" data-dues= "'+value.dues+'"  data-status ="'+value.stat+'"data-label = "'+value.label+'" data-payment_mode = "'+owner.payment_id+'" '+
