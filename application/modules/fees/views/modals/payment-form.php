<?php session_start(); ?>
<div id="payment-form" class="modal modal-styled fade in">
															...
															<td>
																...
																<div class="form-group">
																	...
																	<div class="input-group col-sm-6 padding-left-0">
																		...
																		<input type="hidden" name="cashier" id="cashier" value="<?php $info = $this->session->userdata; echo $info['firstname'].' '.$info['lastname'];?>"/>
