									...
									<div class="col-sm-6">
										...
										<div class="col-sm-2 input-group">
											<?php echo form_input(array(
												'name' => 'delinquent_year',
												'id' => 'delinquent_year',
												'placeholder' => 'YYYY',
												'type' => 'number',
												'class' => 'form-control add-delinquentyear',
												'style' =>'display:none;'
											)); ?>
										</div>
				...
				<div class="modal-footer">
					<div class="action-block">
						<div class="submit-btn inline-block">
							...
							<button type="button" class="btn btn-outline btn-info close-modal" data-dismiss="modal" aria-hidden="true">Save</button> 
						</div>
					</div>
				</div>
			<?php echo form_close(); ?>
