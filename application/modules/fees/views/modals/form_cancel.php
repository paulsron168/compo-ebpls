<div id="form_cancel" class="modal modal-styled fade in">
<div class="modal-dialog width-701-important">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close close-modal" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h3 class="modal-title">Cancelled Businessess</h3>
		</div>
		<div class="modal-body">
			<div class="container detailcancel">
				<div class="row">
					<div class="col-lg-6">
					<!-- FOR NEW APPLICATION -->
					...
					<div class="col-sm-12">
						...
						<div class="method-cash col-sm-12 save-cash" style="display: none">	
							<div class="col-sm-12 form-group cashni">
								...
								<input type="hidden" name="cancelled_id" value="" />
						...
						<div class="method-check col-sm-12 save-check" style="display: none">
							<div class="col-sm-12 form-group checkni">
								<?php echo form_open('', array(
								...
								<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading"><h3 align="center">CHEQUE</h3></div>
									<div class="panel-body">
										<table class="table table-bordered table-styled cash-click">														
											<tbody id="checkni">
												<tr>
													<td>
														...
														<div class="form-group">
															...
															<div class="input-group col-sm-6 padding-left-0">
																<!-- <span class="input-group-addon">&#8369;</span> -->
																<input type="hidden" class="form-control" name="change" readonly />
														...
														<div class="form-group">
															<label class="col-sm-4 control-label">CHEQUE #</label>
															<div class="col-sm-6 padding-left-0">
																<input type="text" class="form-control" required name="chequeno" value="" />
																<input type="hidden" name="paid_tax" id="paid_tax"/>
															</div>
														</div>
														<div class="form-group">
