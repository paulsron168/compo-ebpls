...
<button class="btn btn-danger print-btn" onclick="myPrint()">Click this button<br> to PRINT</button>	
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-4">
					...
					<img src="<?php echo base_url('assets/img/logos/logo2.png'); ?>" width="100" heigth="100" style="position:absolute;margin-left:-60%;margin-top:2%;">
	...
	<br>
		...
		<br><br>
			...
			<?php echo strtoupper($admin[2]->firstName." ".$admin[2]->middleName." ".$admin[2]->lastName)?>	
			<p style="margin-top:0%;font-size:15px;" >
			<?php echo $admin[2]->designation?> 
				<?php //echo $admin[0]->designation?> </p>
			</div>
		</center>
