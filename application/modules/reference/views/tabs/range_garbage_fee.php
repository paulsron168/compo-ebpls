<div class="tab-pane fade in" id="garbage_fee">
	<div class="portlet">
		...
		<div class="portlet-header">
			...
			<ul class="portlet-tools pull-right">
				<li>
					<a id="add-garbage_fee" class="btn btn-sm btn-primary">
						<i class="fa fa-plus-circle"></i> Add New Garbage Fee
					</a>
				</li>
			</ul>
		</div>
						...
						<tr>
							...
							<?php  foreach ($vals as $rv){ ?>
									<tr style="border-top:none; width:50%">										
										...
										<td width="150px">
											<a href="#" data-req_id="<?php echo $rv->id; ?>" class="btn btn-warning btn-xs editgarbagerange"
												...
												data-rid="<?php echo $r->gid?>" 
												><i class="fa fa-edit-garbage-fee"></i> Edit</a>
