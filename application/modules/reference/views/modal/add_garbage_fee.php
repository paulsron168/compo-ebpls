<div id="new-garbage_fee" class="modal modal-styled fade">
	<div class="modal-dialog width-600-important">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close close-modal" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title">Garbage Fee Form</h3>
			</div>

			<?php echo form_open('', array('class' => 'form-horizontal add-garbage-fee-form', 'role' => 'form')); ?>
						...
						<div class="row">
							<div class="col-md-12">								
								...
								<div class="range-garbage-fee">
									...
									<div class="form-group">														
										<div class="range-garbage-fee-form">
										<h4 class="heading margin-bottom-0">Manage Amount Range</h4>
										
										<div class="row garbage-fee text-center margin-top-5">
												...
												<div class="form-group description"> 
													<label class="col-sm-4 control-label">Sub-Description: </label>
														<div class="input-group col-sm-8 padding-left-0">
															...
															<input type="text" class="form-control sub-descs" name="sub-desc" placeholder="Sub-Description" />
														</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group col-sm-8 padding-left-0">
														...
														<input type="text" class="form-control mins"  placeholder="0.00" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group col-sm-8 padding-left-0">
														<span class="input-group-addon">&#8369;</span>
														<input type="text" class="form-control maxs" placeholder="0.00" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="input-group col-sm-8 padding-left-0">
														<span class="input-group-addon">&#8369;</span>
														<input type="text" class="form-control vals"  placeholder="0.00" />
														<input type="hidden" class="form-control ids" name="id" value="1" />
													 	<input type="hidden" class="form-control gid" name="gid"  /> 
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-4 control-label"></label>
													<div class="input-group col-sm-8 padding-left-0">
														<a href="#" class="btn btn-info add-garbage-fee"><i class="fa fa-plus-circle"></i> Add Range</a>
													</div>
												</div>
											</div>
										</div>
