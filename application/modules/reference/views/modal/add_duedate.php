<div id="new-duedate" class="modal modal-styled fade">
	<div class="modal-dialog width-600-important">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close close-modal" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3 class="modal-title">New Due Date</h3>
			</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<?php echo form_label('Payment Mode:', 'value', array('class' => 'col-sm-4 control-label')); ?>
									<div class="col-sm-8">
										<?php 
										$paymenttype= array(
												'1'=>'Annual',
										...
										echo form_dropdown('payment_mode', $paymenttype, '', 'class="form-control"');?>
									</div>
								</div>
							</div>
						</div>
