...
<body>
	...
	<table align="center"  id="tabl" width="650">
		<tr>
			...
			<td>
			<div id="lgo"><img src="<?php echo base_url('assets/img/2.png'); ?>" ></div>
				<h5><span class='rep'>Republic of the Philippines</span><br>
				<span class='pro'>Province of Cebu</span><br>
				<span class='rep'>Municipality of Balamban</span><br></h5>
				<span class='off'><h4><b>OFFICE OF THE MUNICIPAL TREASURER</b></h4></span>
				<span class='off'><h4><U><b>NOTICE OF BILLING</b></U></h4></span>
				...
				<br>
				<span class="no6">Balamban, Cebu </span>
						...
						foreach ($duedate as $due){
							...
							?>						
								<tr>
									...
									<td>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &#8369  <?php echo $data['penalty']; $penalty = $data['penalty'] ?></td>							
									<td> &nbsp; &nbsp; &nbsp;  &#8369 <?php
														if ($payment_mode==3 && $cntr==0){
															echo $data['amount']['annually'];
				...
				<span class="total"><B>TOTAL AMOUNT DUE: &#8369 <?php echo number_format(($total_tax_due + $penalty),2,'.','') ;?> </B></span>
				<br>
				<br>
