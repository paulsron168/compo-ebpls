<?php $data['ownership_type'] = dropdown_options($ownership_type, 'ownership_id', 'types', 'Ownership Type');?>
<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	    	<br>
	    	<div class="panel panel-success">
	    		...
	    		<div class="panel-body">
	    			<div class="row">
							<form target="_blank" method="post"  action="<?php echo site_url('report/report/temp_permit_report_search'); ?>">
	    						<div class="col-sm-4">
