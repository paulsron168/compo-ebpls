...
<?php echo form_open('', array('class' => 'form-horizontal corporate', 'role' => 'form','id'=>'corporate2')); ?>
	...
	<table class="table table-bordered" style="width:60%;">
		...
		<tr>
			...
			<td></p><input type="text" name="basic_tax"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td></p><input type="text" name=""></td>
			<td></p><input type="text" name="earnings"></td>
		</tr>
		<tr>
			...
			<td></p><input type="text" name=""></td>
			<td></p><input type="text" name="salaries"></td>
		</tr>
		<tr>
			<td colspan="2">INCOME FROM REAL PROPERTY (P1.00 FOR EVERY P1,000.00)</td>
			<td></p><input type="text" name=""></td>
			<td></p><input type="text" name="income"></td>
		</tr>
